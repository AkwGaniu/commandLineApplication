This is a simple command line appliation that fetches Treehouse's API and print to the console the number of badges and Javascript points each user has.
